...
public class CsvUpload {
  ...
  static final String PUBLIC_API_KEY = "AIzaSyBMpNTAZzx-fsGoUoDOgJ1wjF4XrRp6fPk";
  ...
  public void run(String projectId, String csvFileName, String vrtFileName) throws Exception {
    ...
    // start hitting the server too quickly.
	    MapsEngineRequestInitializer apiKeyInitializer =
    	    ...
    	    MapsEngine engine = new MapsEngine.Builder(httpTransport, jsonFactory, null)
    	        .setMapsEngineRequestInitializer(apiKeyInitializer)
    	        .setApplicationName("Google-MapsEngineSample/1.0")
    	        .build();

    // The MapsEngine object will be used to perform the requests.
    engine = new MapsEngine.Builder(httpTransport, jsonFactory, (HttpRequestInitializer) apiKeyInitializer)
